...
pub const TEXT_CELL_SIZE: usize = 2;
pub const TEXT_PAGE_SIZE: usize = TEXT_CELL_COUNT * TEXT_CELL_SIZE;
pub const TEXT_DEFAULT_FG: u8 = 3;
pub const TEXT_DEFAULT_BG: u8 = 0;
pub const TEXT_DEFAULT_ATTR: u8 = (TEXT_DEFAULT_BG << 4) | TEXT_DEFAULT_FG;
